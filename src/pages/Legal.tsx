...
const documents: Record<string, LegalDocument> = {
  ...
  "/terms": {
    ...
    sections: [
      ...
      { title: "Rewards and availability", paragraphs: ["Points, badges, titles, profile effects, and ranking recognition have no cash value and cannot currently be withdrawn or exchanged for money. A separately announced partner reward may have its own eligibility and delivery terms. Features, schedules, rewards, and availability may change, but published commitments will be handled fairly and transparently."] },
  ...
  "/contest-rules": {
    ...
    sections: [
      { title: "Eligibility and entry", paragraphs: ["No purchase is necessary. Enter before the published deadline using an eligible account. Age, country, format, and partner-reward restrictions may be specified on each challenge page. Minors need permission from a parent or legal guardian where required."] },
      ...
      { title: "Rewards", paragraphs: ["Current platform rewards are non-cash points, badges, titles, profile recognition, or ranking features. They cannot be withdrawn or exchanged for money. If a challenge offers a separate partner reward, its description, eligibility, delivery timing, and any applicable tax responsibility will be stated on the challenge page or winner notice."] },
